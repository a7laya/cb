<template>
	<view class="position-fixed top-0 w-100" style="z-index: 2020;">
		...
		<view v-if="showSearchBar" class="d-flex a-center j-sb w-100 main-bg-hover-color animated fadeInDown faster" style="height: 100rpx;">
			<text v-show='showLeftIcon' class="test text-white mx-3" style="font-size: 50upx;" @click="$emit('add')">&#xe600;</text>
			<input type="text" 
