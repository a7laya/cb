	...
	<view class="page page-block">
		...
		<view class="vdtu-name">
			<view class="" v-for="(vdtu,index) in vdtuList" :key="index">
				<view class="the-first_item" v-if="vdtu.istheMonthFirstItem">
				...
				<uni-collapse @change="change" >
					<uni-collapse-item ref="add" :title="`${vdtu.location}` + `  [${vdtu.meter_id}]`" :show-animation="true"  thumb="../../static/icons/guess-u-like.png" >
						<view class="data-block">
							...
							<view class="value">
								<text class="value-text">{{vdtu.year}}-{{vdtu.month}}</text>				
							</view>
						</view>	
						<view class="data-block">
							<view class="title">
						...
						<view class="data-block">
							...
							<view class="value">
								<text class="value-text">{{vdtu.zxljl}}</text>				
							</view>
						</view>	
						<view class="data-block">
							<view class="title">
							...
							<view class="value">
								<text class="value-text">{{vdtu.fxljl}}</text>				
							</view>
						</view>	
					</uni-collapse-item>
				</uni-collapse>	
